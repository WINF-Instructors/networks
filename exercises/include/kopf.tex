...
\begin{center} 
  \hrulefill \\[0.1cm]
  {\large "Ubung zur Vorlesung} \\[0.15cm]
  {\huge \bfseries Netzwerke} \\[0.10cm]
  ...
  \begin{tabular}{lcr}
    ...
    %Erlaubte Hilfsmittel: alles inklusive Notizen, B"ucher, Taschenrechner, Laptop, Internet etc.%Blatt \blattnummer     % \abgabetermin          \\ 
  \end{tabular} \\[0.1cm]
  \hrulefill
\end{center}